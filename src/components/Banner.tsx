    ...
    <div>
      {bannerVisible && (
        <div className="bg-linear-to-r from-app-green via-emerald-800 to-app-green text-white text-xs sm:text-sm relative overflow-hidden">
          {/*  ===== */}
          <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 py-2 flex items-center justify-center gap-6">
            {/* // nested div 2 */}
            <div className="flex items-center gap-2 text-center">
              <TruckIcon className="size-8 shrink-0" />
            ...
            <div className="hidden sm:flex items-center gap-2 text-2xl">
              <ZapIcon className="size-6.5 fill-yellow-400 text-yellow-400 shrink-0" />
